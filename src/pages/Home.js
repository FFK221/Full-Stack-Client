...
function Home() {
    ...
    */
    ...
    useEffect(() => {
      ...
      axios.get("https://full-stack-api-shop.herokuapp.com/auth/login", {headers: {'Access-Control-Allow-Origin': 'https://endearing-melomakarona-a48dff.netlify.app'}}).then((response) => {
